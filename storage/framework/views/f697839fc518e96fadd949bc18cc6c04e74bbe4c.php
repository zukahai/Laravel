...
<!--end::Head-->
<!--begin::Body-->
<body <?php echo $__env->yieldContent('onload'); ?> id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
            ...
            <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="../../demo1/dist/index.html" class="d-lg-none">
                        <img alt="Logo" src="<?php echo e(asset('/admin/assets/media/logos/default-small.svg')); ?>" class="h-30px"/>
                    </a>
                </div>
                <!--end::Mobile logo-->
            ...
            <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                ...
                <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                    ...
                    <a href="../../demo1/dist/index.html">
                        <img alt="Logo" src="<?php echo e(asset('/admin/assets/media/logos/default-dark.svg')); ?>"
                             class="h-25px app-sidebar-logo-default"/>
                        <img alt="Logo" src="<?php echo e(asset('/admin/assets/media/logos/default-small.svg')); ?>"
                ...
                <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                    ...
                    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                        ...
                        <!--begin::Menu-->
                        <?php echo $__env->make('staff.includes.menus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <!--end::Menu-->
                    </div>
                    <!--end::Menu wrapper-->
                </div>
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                <!--begin::Title-->
                                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0"><?php echo $__env->yieldContent('title_component'); ?></h1>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-muted"><?php echo $__env->yieldContent('title_layout'); ?></li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <?php echo $__env->yieldContent('actions_layout'); ?>
                            </div>
                            <!--end::Actions-->
                        </div>
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid">
                           <?php echo $__env->yieldContent('content_layout'); ?>
...
<?php /**PATH G:\Laravel\resources\views/staff/layouts/main.blade.php ENDPATH**/ ?>