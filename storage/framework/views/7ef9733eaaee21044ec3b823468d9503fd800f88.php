<?php $__env->startSection('title_page'); ?>
    Rank - <?php echo e(config('app.name')); ?>
...
<?php $__env->startSection('content_card'); ?>
    ...
    <table class="table search-table-outter">
        ...
        <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $ranks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="align-middle">
                ...
                <td class="align-middle text-center"><?php echo e($item->rank_name); ?></td>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\resources\views/admin/pages/rank/index.blade.php ENDPATH**/ ?>