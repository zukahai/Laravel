<?php $__env->startSection('title_page'); ?>
    Edit - Role - Admin - <?php echo e(config('app.name')); ?>
            ...
            <div class="col-sm-10">
                <?php $__currentLoopData = $color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="color" id="inlineRadio1" value="<?php echo e($item); ?>" <?php echo e($item == $role->color ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\resources\views\admin\pages\role\edit.blade.php ENDPATH**/ ?>