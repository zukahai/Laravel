<?php $__env->startSection('title_page'); ?>
    Profile - <?php echo e(config('app.name')); ?>
...
<?php $__env->startSection('actions_layout'); ?>
    <?php if(auth()->user()->account_id == $account->id): ?>
    <a href="<?php echo e(route('user.profile.edit')); ?>/<?php echo e($account->id); ?>" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="<?php echo e(url($account->user->url_avata)); ?>" alt="avatar"
                                 class="rounded-circle img-fluid" style="width: 150px;">
                            <h5 class="my-3"><?php echo e($account->username); ?></h5>
                            <?php $__currentLoopData = $account->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <h6><span class="badge badge-<?php echo e($role->color); ?>"><?php echo e($role->role_name); ?></span> <?php echo e($role->description); ?></h6>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo e($account->user->full_name); ?></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo e($account->user->email); ?></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo e($account->user->phone); ?></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo e($account->user->address); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('user.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\resources\views/user/pages/profile/index.blade.php ENDPATH**/ ?>